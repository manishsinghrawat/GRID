...
Function calculate(strx As String, var As String, varx As String)
...
If Mid(mem, start - 3, 4) = "ASIN" Then
strx = arcsin(CDbl(strx))
start = start - 4
ElseIf Mid(mem, start - 3, 4) = "ACOS" Then
strx = arccos(CDbl(strx))
start = start - 4
ElseIf Mid(mem, start - 2, 3) = "ATN" Then
strx = Atn(CDbl(strx))
start = start - 3
ElseIf Mid(mem, start - 2, 3) = "SIN" Then
strx = Sin(strx)
start = start - 3
...
strx = Tan(strx)
start = start - 3
ElseIf Mid(mem, start - 1, 2) = "IN" Then
strx = Log(strx)
start = start - 2
...
strx = Sqr(strx)
start = start - 3
ElseIf Mid(mem, start - 2, 3) = "RND" Then
strx = Round(strx)
start = start - 3
strx = CDbl(strx)
End If
